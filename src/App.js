    ...
    <div>
      <div className="bg-[#1bcb81] p-4  flex justify-center items-center gap-x-8 text-white text-sm w-full z-10">
        ...
        >
          ...
          <span className="font-semibold pl-3 text-white">
            BOOK APPOINTMENT
          </span>
        </div>
      ...
      <div className="sticky top-0 bg-white shadow z-20 text-[#002E5B]">
        <div className="flex items-center justify-between max-w-screen-xl mx-auto px-6 py-3 text-[#002E5B]">
          ...
          <div className="flex flex-[2] gap-x-12 text-sm font-semibold">
            ...
            <Link
              to="/aboutus"
              className={isActive("/aboutus") ? activeClass : defaultClass}
            >
              ABOUT US
            </Link>
            <Link
              to="/services"
              className={isActive("/services") ? activeClass : defaultClass}
            >
              SERVICES
            </Link>
            ...
            <Link
              to="/partnership"
              className={isActive("/partnership") ? activeClass : defaultClass}
            >
              PARTNERSHIP
            </Link>
            <Link
              to="/contactus"
              className={isActive("/contactus") ? activeClass : defaultClass}
            >
              CONTACT US
            </Link>
            ...
            <div className="flex gap-4">
              ...
              >
                <FontAwesomeIcon
                  icon={faFacebook}
                  className="w-5 h-5 text-green-500 cursor-pointer transition-colors duration-300"
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.color = "#0E3A59")
                  }
      ...
      <div className="pt-6">
        <Routes>
          ...
          <Route
            path="/college_p"
            element={<College_planning></College_planning>}
          ></Route>
      ...
      <footer className="bg-[#002e5b] text-white">
        <div className="bg-[#19e49a] px-6 py-4 flex flex-col sm:flex-row justify-between items-center">
          <h2 className="text-xl sm:text-2xl font-bold">
            Looking For A Financial Consultant?
          </h2>
          <button
            onClick={() => navigate("/baa")}
        ...
        <div className="max-w-screen-xl mx-auto px-8 md:px-16 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-sm">
          <div>
            <h3 className="text-xl font-bold border-t-2 border-[#19e49a] pt-2 mb-3">
              ABOUT
            </h3>
            <p className="text-gray-300">
              At Retire Wisely Financial Services, we strive to simplify your
              financial life after your retirement. We help high-net-worth
              families, and business owners set tangible goals and then put
              strategies in place that assist them in achieving those goals
              through thoughtful planning and open communication.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-bold border-t-2 border-[#19e49a] pt-2 mb-3">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>
                <Link to="/retirement_p">Retirement planning</Link>
              </li>
              <li>
                <Link to="/college_p">College Planning</Link>
              </li>
              <li>
                <Link to="/tax_p">Tax planning</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 gap-y-1">
              ...
              <li>
                <Link to="/baa">Book an Appointment</Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-400 py-4 px-6 flex flex-col sm:flex-row justify-between items-center text-gray-400 text-sm">
          ...
          <div className="flex gap-4 mt-3 sm:mt-0 pr-40">
            <a
              href="#"
              className="bg-white text-green-500 p-2 rounded-full hover:text-[#0E3A59] transition-colors duration-300"
            >
